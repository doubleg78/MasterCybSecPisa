# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 13:43:33 2017
...
# SSLContext for connecting to Server with client authentication:
sslContext = ssl.create_default_context(purpose=ssl.Purpose.SERVER_AUTH)
sslContext.load_verify_locations("ca_cert.pem")
sslContext.load_cert_chain("client_cert.pem", "client_prvkey.pem")
